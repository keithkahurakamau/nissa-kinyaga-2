...
export default [
  {
    ...
    imageAlt: 'A leopard resting low in tall grass during the heat of the day',
    category: 'Field Notes · Leopard',
    title: 'Why the leopard taught me patience',
    body: [
      'Hours of stillness for thirty seconds of grace, and why those seconds are worth every one of the hours.',
      "Big cats were my first love in this work, and the leopard schools you fastest. She rests through the heat, unhurried, and the only thing you can do is match her pace: cut the engine, watch the ears, and let the bush forget you're there. That is the whole craft, and it is the same patience I bring to every sighting I share with a guest.",
    ],
  },
  {
    image: '/assets/p12.jpg',
    imageAlt: 'A rhino grazing with cattle egrets picking insects from the disturbed grass',
  ...
  {
    image: '/assets/mukogodo.jpg',
    imageAlt: 'The Mukogodo highlands of northern Kenya at golden hour',
    category: 'Heritage',
