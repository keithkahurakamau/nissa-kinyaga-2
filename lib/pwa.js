...
import { HASHED, versionedAsset } from './assets.js';
...
const PRECACHE = [
  ...
  HASHED['styles.css'],
  HASHED['app.js'],
  versionedAsset('/assets/icon-192.png'),
...
export function manifest() {
  return {
    ...
    icons: [
      { src: versionedAsset('/assets/icon-192.png'), sizes: '192x192', type: 'image/png', purpose: 'any' },
      { src: versionedAsset('/assets/icon-512.png'), sizes: '512x512', type: 'image/png', purpose: 'any' },
      ...
      { src: versionedAsset('/assets/icon-maskable-512.png'), sizes: '512x512', type: 'image/png', purpose: 'maskable' },
    ],
    shortcuts: [
