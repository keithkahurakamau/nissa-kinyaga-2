...
export function manifest() {
  return {
    ...
    icons: [
      ...
      // The mark sits well inside the 80% safe circle on a full-bleed
      // background, so the same file survives Android's circle and squircle
      // masks without a separate padded export.
